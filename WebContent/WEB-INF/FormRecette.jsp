		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="formRecettes.html">Nouvelle recette</a></li>
					<li>
		...
		<div class="row content">
			...
			<div class="col-sm-8 col-lg-6 text-left">
				...
				<!--Première section -->
					<div class="panel panel-info">
						...
						<div class="panel-body">
							...
							<div class="form-group">
								...
								<textarea class="form-control" id="descRecette" name="descRecette"></textarea>
							</div>
							...
							<label for="tempsRecette">Temps de préparation</label>
								<div class="form-inline" id="tempsRecette">
									<input class="form-control form-control-inline" type="number" min="0" step="1" max="99" id="heureRecette" name="heureRecette">
									<label for="heureRecette"> h</label>
									<input class="form-control form-control-inline" type="number" min="0" step="1" max="59" id="minRecette" name="minRecette">
							...
							<ul class="list-group" name="listeInstructions">
								<li class="list-group-item noBorder media">
									...
									<div class="media-body autoWidth">
										<textarea cols="100" placeholder="Instruction" class="form-control" id="instruction1" name="instruction1"></textarea>
									</div>
									<div class="media-right media-middle">
								...
								<li class="list-group-item noBorder media">
									...
									<div class="media-body autoWidth">
										<textarea cols="100" placeholder="Instruction" class="form-control" id="instruction2" name="instruction2"></textarea>
									</div>
									<div class="media-right media-middle">
										<span class="span3 mouseIcon glyphicon glyphicon-plus-sign green"></span>
										<span class="span3 mouseIcon glyphicon glyphicon-minus-sign red"></span>
					...
					<button type="submit" class="btn btn-primary pull-left" id="btnSubmitRecette">Enregistrer</button>
